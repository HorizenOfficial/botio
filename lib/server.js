...
if (config.private_repo) {
    exec('TDIR=$(mktemp -d) && echo https://$(echo $GITHUB_USER):$(echo $GITHUB_PASS)@github.com > $TDIR/gitcreds && git config --global credential.helper store --file $(echo $TDIR)/gitcreds');
}
